...
const T_CHR *MediaLib_rec_GetVersion(T_VOID);
 ...
 * @param	rec_event	[in]	see T_eMEDIALIB_REC_EVENT
 * @return T_BOOL
 * @retval	AK_TRUE		Restart ok
 * @retval	AK_FALSE	Restart fail
 */
T_BOOL MediaLib_Rec_Restart(T_MEDIALIB_STRUCT hMedia, T_S32 hFile);

/**
 * @brief get recofding infomation
 *
 * @author Su_Dan
 * @param	hMedia		[in]	pointer of T_MEDIALIB_STRUCT struct which is returned by MediaLib_Rec_Open function
 * @param	pInfo	    [out]	see T_MEDIALIB_REC_INFO
 * @return T_BOOL
 * @retval	AK_TRUE		get succe
 ...
 */
//T_S32 MediaLib_Rec_ProcessVideo(T_MEDIALIB_STRUCT hMedia,T_U32 ulstreamlen, T_U32 ulMilliSec);
...
/**
 * @brief procese audio and video
 *
 * @author Zhang_Shunhua
 * @param	hMedia		[in]	pointer of T_MEDIALIB_STRUCT struct which is returned by MediaLib_Rec_Open function
 * @param	tickcount	[in]	current audio time
 * @return T_BOOL
 * @retval	AK_TRUE		set ok
 * @retval	AK_FALSE	set fail
 */
T_BOOL MediaLib_Rec_Handle(T_MEDIALIB_STRUCT hMedia,T_U32 tickcount);

/**
 * @brief Set framerate mode
 *
 * @author Zhang_Shunhua
 * @param	hMedia		[in]	pointer of T_MEDIALIB_STRUCT struct which is returned by MediaLib_Rec_Open function
 * @param	fr_mode	[in]	0: normal; 1: 1 fps
 * @return T_BOOL
 * @retval	AK_TRUE		set ok
 * @retval	AK_FALSE	set fail
 */
T_BOOL MediaLib_Rec_SetFramerateMode(T_MEDIALIB_STRUCT hMedia, T_U16 fr_mode);
