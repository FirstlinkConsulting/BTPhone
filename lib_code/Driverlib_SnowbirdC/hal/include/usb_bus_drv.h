...
#define URB_MAX_WAIT_TIME       10 /*some udisk req sense proc exceed 1s,so wait 2s*/
...
#define USB_COMMECT_NOT         0
#define USB_CONNECT_ENUM        0xffff
#define USB_CONNECT_OK          1
