...
{
    T_hFILE foler = FS_INVALID_HANDLE;
...
{
	return File_FindFirst_WithID(path, ret_cnt, path_buf, find_fileinfo);
}
...
{
	return File_FindNext_WithID(obj, Cnt, ret_cnt); 
}
