...
extern void exitcamera_capture(void);
...
extern void initcamera_capture(void);
...
extern void paintcamera_capture(void);
...
extern unsigned char handlecamera_capture(T_EVT_CODE event, T_EVT_PARAM *pEventParm);
...
static int m_s_camera_captureGetNext(T_EVT_CODE event, M_TRANSTYPE *pTrans);
...
static const M_STATESTRUCT m_s_camera_capture =
{
  initcamera_capture,
  exitcamera_capture,
  paintcamera_capture,
  m_s_camera_captureGetNext
};
  ...
  switch(event)
  {
    ...
    case M_EVT_RETURN_ROOT:
      *pTrans = eM_TYPE_RETURN_ROOT;
      break;
    default:
      nextstate = eM_handlecamera_capture;
      *pTrans = eM_TYPE_SCALL;
      break;
  }
  return(nextstate);
...
static M_STATESTRUCT* const m_statearray[] = 
{
 ...
 (M_STATESTRUCT* const)&m_s_camera_capture,
