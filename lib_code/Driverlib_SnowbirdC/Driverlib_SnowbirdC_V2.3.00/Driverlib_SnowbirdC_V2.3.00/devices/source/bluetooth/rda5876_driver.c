...
#if (DRV_SUPPORT_BLUETOOTH > 0) && (BT_RDA5876 > 0)
...
/*******************************************************************************
 * @brief   RDA5876_ENABLE_SPI
 * @author  Liuhuadong
 * @date    2013.07.19
 * note     rdabt spi enable
*******************************************************************************/
...
/*******************************************************************************
 * @brief   RDA5876_DISABLE_SPI
 * @author  Liuhuadong
 * @date    2013.07.19
 * note     rdabt spi disable
*******************************************************************************/
...
const __u32 RDA5876_PSKEY_MISC[][2] =
{
        ...
        {0x800004ec,0x7a8dffff},// LMP Feature High 64 bits
        {0x800004f0,0x83793d98},// LMP Feature Low 64 bits
        
        {0x8000059c,0x00040bbf},// sniff min interval   
    
#if (0 == RDA_HFP_LINK_MODE)
        // bit[3]:1 ∆¡±ŒeSCO liangjian 20130705
        // bit[4]:1 ∆¡±Œ∂‡¡¨Ω” liangjian 20130705
        // bit[17]:1 force to eSCO liangjian 20130712
        {0x80000070,0x00032090},// sysconfig setting
#else
        {0x80000070,0x00032018},// sysconfig setting
#endif
...
const __u32 RDA5876_TRAP[][2] = 
{
	...
	{0x80000100,0xe3a0500f},// 2ev3 ev3 hv3
	{0x4018010c,0x0000aae0},// esco packet 
	{0x4018012c,0x80000100},
	
	{0x40180110,0x00016b20},// esco 
	{0x40180130,0x000000c4},// sleep
...
/*******************************************************************************
 * @brief   RDA5876_BQB_Pskey_RfInit
 * @author  Liuhuadong
 * @date    2013.07.19
 * @param   [in]void
 * @return  T_void
