...
#define UDISK_MAXIMUM_LUN                       5
#define UDISK_BUFFER_NUM                        2
#ifdef UNSUPPORT_REMAP
#define UDISK_BUFFER_LEN                        (16*1024)
#define UDISK_READ_BUF_LEN                      (16*1024)
#define UDISK_WRITE_BUF_LEN                     (16*1024)
#else
#define UDISK_BUFFER_LEN                        (16*1024)
#define UDISK_READ_BUF_LEN                      (16*1024)
#define UDISK_WRITE_BUF_LEN                     (16*1024)
...
/**
 * @brief   scsi cmd 'user define command' process
 *
 * process user define scsi PC request
 * @author Zhs
 * @date 2013-08-30
 * @param lun[in] lun addressed by host
 * @param param expected_bytes[in] trans bytes expected by host
  * @param cmd_param : cmd param
 * @return  T_BOOL
 * @retval  AK_FALSE means proccess successful
 * @retval  AK_TRUE means proccess failed
 */
