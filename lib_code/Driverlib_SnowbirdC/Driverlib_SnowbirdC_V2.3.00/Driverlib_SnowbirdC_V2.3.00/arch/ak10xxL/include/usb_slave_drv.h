...
#define USB_EP_BULKIN_TYPE            0x1
#define USB_EP_BULKOUT_TYPE           0x0
...
#define EP2_DMA_INTR        0x000000010
#define EP3_DMA_INTR        0x000000020
#define USB_INTR            0x000000040
#define EP_UNKNOWN          0x0

#define EP_ATTRIBUTE_CONTROL     0
#define EP_ATTRIBUTE_SYNCH       1
#define EP_ATTRIBUTE_BULK        2
#define EP_ATTRIBUTE_INTR        3
...
#define USB_BULK_IN_INDEX           EP2_INDEX
#define USB_BULK_OUT_INDEX          EP3_INDEX
#define USB_ISO_OUT_INDEX           EP3_INDEX
#define USB_ISO_IN_INDEX            EP2_INDEX
#define USB_INTR_IN_INDEX           EP1_INDEX
/**
...
/**
 * @brief   start usb detect, open usb controller
 *
 * @author  liaozhijun
 * @date    2010-06-30
 * @param   T_VOID
...
/**
 * @brief   get usb connect to pc or not
 *
 * @author  liaozhijun
 * @date    2010-06-30
 * @param   T_VOID
 * @return  T_BOOL
 * @retval  AK_TRUE: connect to pc, AK_FALSE: not
 */
T_BOOL usb_slave_detect_status(T_VOID);

/**
 * @brief   exit usb detect, close usb controller
 *
 * @author  liaozhijun
 * @date    2010-06-30
 * @param   T_VOID
