...
#include "arch_init.h"
#include "drv_cfg.h"
#if (DRV_SUPPORT_CAMERA > 0) && (CAMERA_OV2643 > 0)


#define DEVICE_NAME             "CAMERA:OV2643"
...
#define OV2643_CAMERA_MCLK      300//unit:100Khz
        ...
        else
        {
            ...
            {                
                ...
                if (temp_value != tabParameter[i + 1])
                {
					...
					drv_print( "reg  write data is 0x", tabParameter[i + 1], 1);
					drv_print( "reg  read data is 0x", temp_value, 1);
...
//	gpio_set_pin_as_gpio(GPIO_CAMERA_RESET);
	REG32(REG_SHARE_PIN_CTRL) &= ~(0x03<<10);
...
static T_VOID cam_ov2643_set_exposure(T_CAMERA_EXPOSURE exposure)
{
    switch(exposure)
    {
        ...
        case EXPOSURE_MIDDLE:
            ...
            break;
        default:
			drv_print("set exposure parameter error!\n", 0, 1);
...
static T_VOID cam_ov2643_set_brightness(T_CAMERA_BRIGHTNESS brightness)
{
    switch(brightness)
    {
        ...
        case CAMERA_BRIGHTNESS_6:
            ...
            break;
        default:
			drv_print("set brightness parameter error!\n", 0, 1);
...
static T_VOID cam_ov2643_set_contrast(T_CAMERA_CONTRAST contrast)
{
    switch(contrast)
    {
        ...
        case CAMERA_CONTRAST_7:
            ...
            break;
        default:
			drv_print("set contrast parameter error!\n", 0, 1);
...
static T_VOID cam_ov2643_set_saturation(T_CAMERA_SATURATION saturation)
{
    switch(saturation)
    {
        ...
        case CAMERA_SATURATION_5:
            ...
            break;
        default:
			drv_print("set saturation parameter error!\n", 0, 1);
...
/*    else if ((srcWidth <= 1600) && (srcHeight <= 1200))
    ...
    {
    	drv_print("ov2643 unsupport size!", 0, 1);
...
{   
    ...
    Reg0x13 = 0xe7;
	 cam_ov2643_set_mode(CAMERA_MODE_REC);
...
#endif  //(DRV_SUPPORT_CAMERA > 0) && (CAMERA_GC0308 > 0)
